...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight <= 2)
	nSubsidy = 200000 * COIN; // first 2 blocks are 200000 coin reward
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "28/1/14 - Blockchain Launches";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xab06c248be1a61ee2a70b6ff8acdf94d38d3cdee5831d8b1fc681a42efc43817"));
